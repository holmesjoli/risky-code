...
export default function Algorithm({user, algorithmDefinition, setAlgorithmDefinition, rules, setRules, modules, state, remaining }) {
  ...
  return (
    <div className="Orientation">
        ...
        <h2 className="Small-Bottom">algorithmic prediction</h2>
            <Box sx={{ width: 500 }}>
