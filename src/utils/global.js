...
export const riskVariables = [
    {"id": "citizenData2", "group": "appropriate data use", "name": "Risk of citizen data use", "description":  "Risk of citizen data. Consider if citizen data is used and if citizens opted into data collection"},
    ...
    {"id": "historicalBias", "group": "values", "name": "Risk of historic societal bias.", "description": "Risk of historic societal bias. Consider bias from racism, discrimination, etc."},
    ...
    {"id": "proxyVariables", "group": "technical",  "name": "Risk of proxy outcome variables.", "description": "Risk of proxy outcome variables. Consider if there is a match between the real world and the data."}
];
